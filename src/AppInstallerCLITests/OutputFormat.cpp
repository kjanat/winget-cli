...
TEST_CASE("OutputFormat_SearchCommand_ValidJson", "[OutputFormat][SearchCommand]")
{
...
TEST_CASE("OutputFormat_SearchCommand_ValidTable", "[OutputFormat][SearchCommand]")
{
    std::ostringstream searchOutput;
    TestContext context{ searchOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_SearchCommand_DefaultIsTable", "[OutputFormat][SearchCommand]")
{
    std::ostringstream searchOutput;
    TestContext context{ searchOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_SearchCommand_CaseInsensitive", "[OutputFormat][SearchCommand]")
{
    std::ostringstream searchOutput;
    TestContext context{ searchOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_SearchCommand_WithWhitespace", "[OutputFormat][SearchCommand]")
{
    std::ostringstream searchOutput;
    TestContext context{ searchOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_SearchCommand_InvalidFormat", "[OutputFormat][SearchCommand]")
{
    Args args;
...
TEST_CASE("OutputFormat_SearchCommand_InvalidFormatCsv", "[OutputFormat][SearchCommand]")
{
    Args args;
    args.AddArg(Args::Type::Query, "test");
...
TEST_CASE("OutputFormat_ListCommand_ValidJson", "[OutputFormat][ListCommand]")
{
...
TEST_CASE("OutputFormat_ListCommand_ValidTable", "[OutputFormat][ListCommand]")
{
    std::ostringstream listOutput;
    TestContext context{ listOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_ListCommand_InvalidFormat", "[OutputFormat][ListCommand]")
{
    Args args;
...
TEST_CASE("OutputFormat_ShowCommand_ValidJson", "[OutputFormat][ShowCommand]")
{
...
TEST_CASE("OutputFormat_ShowCommand_ValidTable", "[OutputFormat][ShowCommand]")
{
    std::ostringstream showOutput;
    TestContext context{ showOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_ShowCommand_DefaultIsTable", "[OutputFormat][ShowCommand]")
{
    std::ostringstream showOutput;
    TestContext context{ showOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_ShowCommand_InvalidFormat", "[OutputFormat][ShowCommand]")
{
    Args args;
    args.AddArg(Args::Type::Query, "test");
...
TEST_CASE("OutputFormat_ShowCommand_JsonWithManifest", "[OutputFormat][ShowCommand]")
{
    std::ostringstream showOutput;
    TestContext context{ showOutput, std::cin };
    auto previousThreadGlobals = context.SetForCurrentThread();
...
TEST_CASE("OutputFormat_ValidationNormalization", "[OutputFormat]")
{
